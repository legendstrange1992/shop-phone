					...
					<div class="cart_item d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
						...
						<div class="cart_item_product d-flex flex-row align-items-center justify-content-start">
							<div class="cart_item_image">
								<div><img src="images/<?php echo $giatri_cua_phantu['hinh']?>" alt=""></div>
							</div>
							<div class="cart_item_name_container">
								<div class="cart_item_name"><a href="#"><?php echo $giatri_cua_phantu['tensanpham'] ?></a></div>
								<div class="cart_item_edit"><a href="#">Edit Product</a></div>
							</div>
						</div>
						<!-- Price -->
						<div class="cart_item_price">$ <?php echo  number_format($giatri_cua_phantu['gia'])?></div>
						<!-- Quantity -->
						...
						<!-- Total -->
						<div id="thanhtien_<?php echo $giatri_cua_phantu['id_sanpham']?>" class="cart_item_total">

							 <?php echo number_format($giatri_cua_phantu['thanhtien'])?> VNĐ
